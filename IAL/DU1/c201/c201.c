...
{
	ListElementPtr newEle = malloc(sizeof(struct ListElement));
	if (newEle == NULL)
		List_Error();
	else
	{
...
void List_DeleteAfter(List *list)
{
	...
	ListElementPtr followingEle = list->activeElement->nextElement;
	if (followingEle == NULL)
		return;

	ListElementPtr newNext = followingEle->nextElement;
	free(followingEle);
...
void List_InsertAfter(List *list, int data)
{
	...
	{
		newEle->data = data;
		newEle->nextElement = followingEle;
