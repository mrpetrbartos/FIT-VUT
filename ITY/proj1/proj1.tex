...
Existuje „pravidlo“:
\begin{quotation}
Čím více \emph{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue}{barev} písma a jiných \textcolor{red}{\textsc{efektů}} \underline{použijeme}, tím \textcolor{BurntOrange}{profesionálněji} bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
